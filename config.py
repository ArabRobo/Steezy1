...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6808404171:AAHG_MCcjVk80Kak9gvinsyJekUoqOdBV5I")
...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002122350440"))
...
# Database
DB_URI = os.environ.get("DATABASE_URL", "postgres://mlgtvjnp:gE9nY0JzTQwqwa1aaE_hRvSr1CBrlY8L@castor.db.elephantsql.com/mlgtvjnp")
...
FORCE_SUB_2 = int(os.environ.get("FORCE_SUB_2", "-1001734256017"))
FORCE_SUB_3 = int(os.environ.get("FORCE_SUB_3", "-1001677975298"))
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "5684155058").split())]
except ValueError:
